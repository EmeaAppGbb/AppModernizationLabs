...
|-----------|----------|----------|
| Frontend / UI / HTML / CSS / JS | Data | Build pages, components, layout, responsive, interactions |
| Design / Styling / Theming / Retro | Sloth | CSS themes, color palettes, typography, UI design, retro aesthetic |
| Pixel art / Icons / Sprites / Graphics | Andy | Create pixel art, SVG icons, sprites, graphical assets |
| CI/CD / GitHub Actions / Automation | Chunk | Workflows, pipelines, deployment, lab ingestion, issue automation |
| Docs / README / LICENSE / Templates | Mouth | README, LICENSE, CONTRIBUTING, issue templates, lab templates |
| Code review / Architecture | Mikey | Review PRs, check quality, architecture decisions |
| Testing / QA / Validation | Stef | Write tests, find edge cases, verify fixes, validate data |
