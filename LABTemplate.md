# Lab Template — APPMODLAB.MD

Copy this file to your repository root and rename it to `APPMODLAB.MD`.
Fill in the metadata below. Required fields are marked with * and should not be removed.

⚠️ **Important:** Keep the YAML frontmatter structure exactly as shown. The gallery parser reads this metadata to populate the lab gallery.
...
video: "" # (Optional) URL to demo video or walkthrough. Example: "https://example.com/demo.mp4" or "https://www.youtube.com/embed/VIDEO_ID"
version: "" # (Optional) Semantic versioning (e.g., "1.0.0", "1.2.3"). Use if your lab receives updates.
---

# Your Lab Title Here

Write your lab content below this frontmatter. Include:
...
The content is rendered as Markdown on the lab detail page in the gallery.
